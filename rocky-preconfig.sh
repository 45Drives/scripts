...
houston_configuration() {
    ...
    dnf install -y cockpit cockpit-pcp cockpit-zfs-manager cockpit-benchmark cockpit-navigator cockpit-file-sharing cockpit-45drives-hardware cockpit-identities \
